          ...
          <div className="relative mx-auto text-center flex flex-col items-center gap-10">
            <div>
              <Heading>
                ...
                bg-clip-text">Delivery to your Discord</span>
              </Heading>
            </div>

            <p className="text-base/7 text-gray-600 mx-w-prose text-center text-pretty">PingPanda is the easiest way to monitor your SaaS.
              Get instant notifications for <span className="font-semibold text-gray-700">sales, new users or
                any other event
            ...
            <ul className="space-y-2 text-base/7 text-gray-600 text-left flex flex-col
             items-start">
              {["Real-time Discord alerts for ctitical events", 
                    ...
                    rounded-tl-xl bg-gray-900 shadow-2xl">
                      <div className="flex bg-gray-800/40 ring-1 ring-white/5">
                        <div className="-mb-px flex text-sm/6 font-medium text-gray-400">
                          ...
                          bg-white/5 px-4 py-2 text-white">pingpanda.js</div>
                        </div>
                      </div>
                    </div>
                </div>
