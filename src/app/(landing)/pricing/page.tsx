        ...
        <div className="bg-brand-25 py-24 sm:py-32">
            <MaxWidthWrapper>
                <div className="mx-auto max-w-2xl sm:text-center">
                    ...
                    <p className="mx-auto mt-6 text-base/7 text-gray-600 max-w-prose text-center text-pretty">We hate subscriptions. And chances are, you do too. Thats's
                        why we offer lifetime access to Natureggae for a one-time payment.
                    </p>
                </div>
                ...
                <div className="bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                    <div className="p-8 sm:p-10 lg:flex-auto">
                        ...
                        <p className="mt-6 text-base/7 text-gray-600">
                            Invest once Natureggae and transform how you monitor your SaaS forever.
                            Get instant alerts, track critical metrics and never miss a beat
