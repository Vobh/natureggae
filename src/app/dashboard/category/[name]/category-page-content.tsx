...
// https://localhost:300/dashboard/category/sale?page=5&limit=30
...
const columns: ColumnDef<Event>[] = useMemo(() => [
    ...
    ...(data?.events[0] ? Object.keys(data.events[0].fields as Record<string, any>).map((field) => ({
