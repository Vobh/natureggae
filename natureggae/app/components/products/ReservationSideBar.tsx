const ReservationSideBar = () => {
    return (
        <aside className="mt-6 p-6 col-span-2 rounded-xl border border-gray-300 shadow-xl">
            <h2 className="mb-5 text-2xl">$200 the show</h2>
            ...
            <div className="w-full mb-6 py-6 text-center text-white bg-natureggae hover:bg-natureggae-dark rounded-xl">Book</div>
