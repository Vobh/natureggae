        ...
        <div className="max-w-3xl flex flex-col gap-8">
            <div>
                ...
                <p className="text-sm/6 text-gray-600 max-w-prose">
                    {plan === "PRO" ? "Thank you for supporting Natureggae. Find your increased usage limits below."
            ...
            <p className="text-sm text-gray-500">
                ...
                {plan !== "PRO" ? <span onClick={() => createCheckoutSession()} className="inline cursor-pointer underline text-brand-600">
